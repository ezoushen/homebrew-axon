...
class Axon < Formula
  ...
  url "https://github.com/ezoushen/axon/archive/refs/tags/v0.4.0.tar.gz"
  sha256 "95716d08273e46f0fffec0163eb4d154954c25316cf2290f7bdfd17b222975d3"  # Generate with: shasum -a 256 v0.1.0.tar.gz
  license "ISC"
  version "0.4.0"
