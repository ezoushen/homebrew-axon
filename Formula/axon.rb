...
class Axon < Formula
  ...
  url "https://github.com/ezoushen/axon/archive/refs/tags/v0.6.0.tar.gz"
  sha256 "789ccd0be18adb35a2c9e01b9fdacef24d455cc4f908f8a03d8e67d25b9117b8"  # Generate with: shasum -a 256 v0.1.0.tar.gz
  license "ISC"
  version "0.6.0"
