...
class Axon < Formula
  ...
  url "https://github.com/ezoushen/axon/archive/refs/tags/v0.8.4.tar.gz"
  sha256 "98a971882b7f839958b182ff32512020d6220feb1444f55c03184f2d6c1d3a15"  # Generate with: shasum -a 256 v0.1.0.tar.gz
  license "ISC"
  version "0.8.4"
