...
class Axon < Formula
  ...
  url "https://github.com/ezoushen/axon/archive/refs/tags/v0.2.1.tar.gz"
  sha256 "d4d92edfc8b22b281922a71a53439a12d33396b408fd98de2b875a93753eff29"  # Generate with: shasum -a 256 v0.1.0.tar.gz
  license "ISC"
  version "0.2.1"
