...
class Axon < Formula
  ...
  url "https://github.com/ezoushen/axon/archive/refs/tags/v0.1.7.tar.gz"
  sha256 "fd4b91438de9a0cda42215d376df9b5f33c883d397c86f3665eda762eea5e7be"  # Generate with: shasum -a 256 v0.1.0.tar.gz
  license "ISC"
  version "0.1.7"
